...
//   const [searchTerm, setSearchTerm] = useState("");
//   const [filters, setFilters] = useState({ department: "", year: "", gender: "" });
//   const [showFilters, setShowFilters] = useState(false);
...
//                 value={searchTerm}
//                 onChange={(e) => setSearchTerm(e.target.value)}
//                 className="w-full pl-10 pr-4 py-3 rounded-md bg-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-400"
//               />
//             </div>
...
//               <button
//                 onClick={() => setShowFilters(!showFilters)}
//                 className="flex items-center justify-center gap-2 px-4 py-3 rounded-md bg-gray-700 hover:bg-gray-600 text-white w-full sm:w-auto"
//               >
//                 <Filter className="w-5 h-5" />
//                 Filters
//                 {showFilters ? <ChevronUp className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
...
//         <div className="bg-gray-800 rounded-lg overflow-hidden">
//           <div className="overflow-x-auto scrollbar-thin max-w-full">
//             <table className="w-full min-w-[350px] sm:min-w-[700px] md:min-w-[1000px]">
//               <thead className="bg-gray-700">
//                 <tr>
...
//       {/* Modals */}
//       {selectedGuide && !viewMode && (
//         <EditGuideModal guide={selectedGuide} onClose={() => setSelectedGuide(null)} />
//       )}
//       {selectedGuide && viewMode && (
//         <ViewGuideModal guide={selectedGuide} onClose={() => setSelectedGuide(null)} />
//       )}
//       {showConfirmDelete && (
//         <ConfirmModel
//           isOpen={showConfirmDelete}
