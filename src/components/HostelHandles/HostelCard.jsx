  ...
  return (
    <div className="bg-gray-800 rounded-xl border overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
      ...
      <div className="relative h-48 md:h-56">
        {/* Admin Edit/Delete buttons at top-left */}
        {userType === 'admin' && (
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-1 text-gray-400 text-sm h-12">
          ...
          <span className="line-clamp-2">{hostel.address?.full || hostel.address}</span>
        </div>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-700 mt-3">
          <button className="text-sm font-semibold bg-yellow-400 text-black px-4 py-1 rounded-md hover:bg-yellow-300 transition">
            ₹{String(hostel.rent).slice(0, 6)}/Month
          </button>
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-xs text-white">{hostel.contact}</div>
            </div>
          </div>
        </div>
      </div>
