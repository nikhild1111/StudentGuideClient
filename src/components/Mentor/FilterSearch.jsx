      ...
      {showFilters && (
        <div className="w-full mt-3 grid grid-cols-1 md:grid-cols-4 gap-4 bg-gray-800 p-4 rounded-lg">
          ...
          <div className="col-span-full flex gap-3 justify-end mt-2">
            <button
              onClick={handleSearch}
              className="bg-yellow-400 hover:bg-yellow-300 text-black font-semibold px-6 py-2 rounded-lg flex items-center gap-2"
            >
            ...
            <button
              onClick={handleClear}
              className="bg-red-500 hover:bg-red-400 text-white font-semibold px-4 py-2 rounded-lg flex items-center gap-2"
            >
              <XCircle className="w-4 h-4" />
              Clear
            </button>
